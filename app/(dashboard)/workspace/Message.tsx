  ...
  return (
    <div
      className={`group w-full text-white dark:text-gray-100 border-b border-black/10 dark:border-gray-900/50 ${
        isUser ? "" : "bg-gray-800" //"bg-gray-50 dark:bg-[#444654]"
      }`}
    >
      <div className="text-base gap-4 md:gap-6 md:max-w-2xl lg:max-w-xl xl:max-w-3xl flex lg:px-0 m-auto w-full mx-4">
